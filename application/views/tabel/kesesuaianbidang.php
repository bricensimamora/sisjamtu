<div class="col-sm-9">
			<nav>        
				<div class="col-12-ml">
					<ul class='breadcrumb'>
					<li><h6>Tabel Kesesuaian Bidang Kerja Lulusan</h6></li>
					</ul>
				</div>
			</nav>
									...
									<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
										<thead style="text-align: center;">
											<tr>
                                                ...
                                                <th colspan='3' style="text-align:center; padding-bottom:35px">Jumlah Lulusan Terlacak dengan Tingkat Kesesuaian Bidang Kerja</th>			
                                            </tr>
                                            <tr>
                                                <th>Rendah</th>			
                                                <th>Sedang</th>
										...
										<tbody style="text-align: center;">
											<?php foreach ($kesesuaianbidang as $data): ?>
											<tr>
												<td width="150">
                                                ...
                                                <td>
													<?php echo $data->rendah ?>
                                                </td>
                                                <td>
													<?php echo $data->sedang ?>
                                                </td>
                                                <td>
