<div class="col-sm-9">
			<nav>        
				<div class="col-12-ml">
					<ul class='breadcrumb'>
					<li><h6>Tabel PkM DTPS yang Melibatkan Mahasiswa</h6></li>
					</ul>
				</div>
			</nav>
									...
									<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
										<thead style="text-align: center;">
											<tr>
                                                ...
                                                <th rowspan='2' style="text-align:center; padding-bottom:35px">Judul Kegiatan</th>
                                                <th rowspan='2' style="text-align:center; padding-bottom:35px">Tahun</th>			
                                            </tr>
										</thead>
										<tbody style="text-align: center;">
											<?php foreach ($pkmmahasiswa as $data): ?>
											<tr>
												<td width="150">
													<?php echo $data->namaDosen ?>
												</td>
												<td>
													<?php echo $data->temaPkm ?>
												</td>
												<td>
													<?php echo $data->namaMahasiswa ?>
												</td>
                                                <td>
													<?php echo $data->judulKegiatan ?>
                                                </td>
                                                <td>
													<?php echo $data->tahun ?>
                                                </td>
