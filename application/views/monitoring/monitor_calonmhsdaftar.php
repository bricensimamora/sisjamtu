...
$(document).ready(function(){
	...
	function drawChart(result) {
            ...
            data.addColumn('number', 'Jumlah Calon Mahasiswa Tedaftar');
            var dataArray = [];
            $.each(result, function(i, obj) {
                dataArray.push([ obj.tahunAkademik, parseInt(obj.pendaftar) ]);
            });
            ...
            var linechart_options = {
                title : 'Pie Chart: Jumlah Calon Mahasiswa Terdaftar Tiap Tahun',
                curveType : 'function',
            ...
            var barchart_options = {
                title : 'Barchart: Jumlah Calon Mahasiswa Terdaftar Tiap Tahun',
                colors : ['green'],
                width : 412,
                height : 350,
                legend : 'none'
					...
					<div class="container-fluid monitor-body">
						...
						<div class="card mb-3">
							<div class="card-header bg-secondary">
								<h6 class="judul-monitor">Monitoring Calon Mahasiswa Terdaftar</h6>
							</div>
								<div class="card-body">
