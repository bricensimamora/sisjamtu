...
$(document).ready(function(){
	$.ajax({
		url : "<?php echo base_url().'monitoring/jmlkaryasitasi' ?>",
		dataType : "JSON",
	...
	function drawChart(result) {
            ...
            data.addColumn('number', 'Jumlah Judul Karya Ilmiah yang Disitasi');
            var dataArray = [];
            $.each(result, function(i, obj) {
                dataArray.push([ obj.namaDosen, parseInt(obj.jumlahSitasi)]);
            });
