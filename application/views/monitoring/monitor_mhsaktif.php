...
$(document).ready(function(){
	...
	function drawChart(result) {
            ...
            $.each(result, function(i, obj) {
                dataArray.push([ obj.tahunAkademik, parseInt(obj.regulerMahasiswaAktif) ]);
            });
            ...
            var linechart_options = {
                title : 'Pie Chart: Jumlah Mahasiswa Aktif per Tahun',
                curveType : 'function',
            ...
            var barchart_options = {
                title : 'Barchart: Jumlah Mahasiswa Aktif per Tahun',
                colors : ['green'],
                width : 412,
                height : 350,
                legend : 'none'
					...
					<div class="container-fluid monitor-body">
						...
						<div class="card mb-3">
							<div class="card-header bg-secondary">
								<h6 class="judul-monitor">Monitoring Mahasiswa Aktif</h6>
							</div>
								<div class="card-body">
