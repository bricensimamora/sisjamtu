...
$(document).ready(function(){
	$.ajax({
		url : "<?php echo base_url().'monitoring/jmlpagelarandtps' ?>",
		dataType : "JSON",
	...
	function drawChart(result) {
            ...
            var Combo_options = {
               title: 'Monitoring Jumlah Judul Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS Berdasarkan Sumber',
                seriesType :'bars',
                series : {4:{type: 'line'}},
            ...
            var piechart_options = {
                title : 'Distribusi Judul Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS Berdasarkan Sumber',
                width : 766,
                height : 350,
                is3D : true,
                legend : 'bottom'
					...
					<div class="container-fluid monitor-body">
						...
						<div class="card mb-3">
							<div class="card-header bg-secondary">
								<h6 class="judul-monitor">Monitoring Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS</h6>
							</div>
								<div class="card-body">
