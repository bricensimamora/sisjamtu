...
$(document).ready(function(){
	$.ajax({
		url : "<?php echo base_url().'monitoring/jmlpkmdtps' ?>",
		dataType : "JSON",
	...
	function drawChart(result) {
            ...
            data.addColumn('number', 'Jumlah Judul PKM TS-2');
            data.addColumn('number', 'Jumlah Judul PKM TS-1');
            data.addColumn('number', 'Jumlah Judul PKM TS');
            var dataArray = [];
            ...
            var Combo_options = {
               title: 'Monitoring Jumlah Judul PKM Berdasarkan Sumber',
                seriesType :'bars',
                series : {4:{type: 'line'}},
            ...
            data2.addColumn('number', 'Jumlah Judul PKM');
            var dataArray2 = [];
            $.each(result, function(i, obj) {
            ...
            var piechart_options = {
                title : 'Distribusi Judul PKM Berdasarkan Sumber',
                width : 412,
                height : 350,
                is3D : true,
                legend : 'bottom'
					...
					<div class="container-fluid monitor-body">
						...
						<div class="card mb-3">
							<div class="card-header bg-secondary">
								<h6 class="judul-monitor">Monitoring PKM DTPS</h6>
							</div>
								<div class="card-body">
